...
export default function MapBlock(props: MapBlockProps) {
  ...
  return (
    ...
    >
      ...
      {title && (
        <div
          className="absolute p-2 bottom-4 max-w-4/5 truncate left-4 border border-black/3 rounded-lg bg-white/60 backdrop-blur-lg font-sans text-black/80 text-sm"
          title={title}
        >
          {title}
        </div>
